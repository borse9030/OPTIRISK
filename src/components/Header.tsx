    ...
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200/90 h-14 px-4 sm:px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2 sm:gap-3 min-w-0">
        ...
        <div className="flex items-center gap-1 text-xs text-slate-500 min-w-0">
          ...
          <span className="font-semibold text-slate-800 truncate max-w-[125px] sm:max-w-xs">{currentTitle}</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-2.5 py-1 rounded-full bg-slate-50 hover:bg-slate-100 border border-slate-200 text-xs text-slate-700 transition-colors"
          >
            <div className="w-5 h-5 rounded-full bg-blue-100 border border-blue-200 flex items-center justify-center text-[10px] font-bold text-blue-700 shrink-0">
              {activeAvatar}
            </div>
            <span className="font-medium text-slate-700 text-xs hidden sm:inline truncate max-w-[100px]">
              {activeName}
            </span>
          ...
          {showPersonaMenu && (
            <div className="absolute right-0 mt-2 w-72 max-w-[calc(100vw-1.5rem)] bg-white border border-slate-200 rounded-xl shadow-lg p-2.5 z-50 animate-in fade-in zoom-in-95 space-y-2">
