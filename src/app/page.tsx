...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between">
      {/* Top minimal header */}
      <header className="border-b border-slate-200/80 bg-white/80 backdrop-blur-md px-6 py-4 flex items-center justify-between max-w-7xl mx-auto w-full sticky top-0 z-30">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-[10px] font-mono text-blue-700 px-1.5 py-0.5 bg-blue-50 rounded border border-blue-200">
              SIH26105
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/dashboard"
            className="text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 px-4 py-1.5 rounded-lg shadow-xs transition-all flex items-center gap-1.5"
          >
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-20 text-center flex flex-col items-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-200 text-xs font-medium text-blue-700 mb-6">
          <span>Smart India Hackathon 2026 • Problem Statement SIH26105</span>
        </div>

        <h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-slate-900 max-w-4xl leading-tight">
          Quantify Cyber Risk.{' '}
        ...
        <div className="mt-12 p-4 rounded-xl bg-white border border-slate-200 shadow-xs max-w-3xl w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-left">
          <div className="p-2 border-r border-slate-100">
            ...
            <div className="text-xl font-bold font-mono text-rose-700 mt-0.5">68 / 100</div>
          </div>
          <div className="p-2 border-r border-slate-100">
            <div className="text-[10px] uppercase font-mono text-slate-500 font-semibold">Baseline EAL</div>
            <div className="text-xl font-bold font-mono text-slate-900 mt-0.5">₹38.4 Lakhs</div>
          </div>
          <div className="p-2 border-r border-slate-100">
            <div className="text-[10px] uppercase font-mono text-slate-500 font-semibold">Security Budget</div>
            <div className="text-xl font-bold font-mono text-slate-900 mt-0.5">₹10.0 Lakhs</div>
          </div>
          <div className="p-2">
            <div className="text-[10px] uppercase font-mono text-slate-500 font-semibold">Optimized Yield</div>
            <div className="text-xl font-bold font-mono text-emerald-700 mt-0.5">2.6× ROSI</div>
          </div>
        </div>
      </section>

      {/* 3 Core Pillars Section */}
      <section className="border-t border-slate-200 bg-white py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Pillar 1: Quantify */}
            <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-6 flex flex-col justify-between hover:border-slate-300 transition-all">
              <div>
                ...
                <h3 className="text-base font-bold text-slate-900 mb-2">1. Quantify</h3>
            ...
            {/* Pillar 2: Optimize */}
            <div className="rounded-xl border border-blue-200 bg-blue-50/30 p-6 flex flex-col justify-between hover:border-blue-300 transition-all">
              <div>
                ...
                <h3 className="text-base font-bold text-slate-900 mb-2">2. Optimize</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-6 flex flex-col justify-between hover:border-slate-300 transition-all">
              <div>
                ...
                <h3 className="text-base font-bold text-slate-900 mb-2">3. Simulate</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 bg-white px-6 py-6 text-center text-xs text-slate-500 max-w-7xl mx-auto w-full flex flex-col sm:flex-row items-center justify-between gap-3">
        <div>
